...
struct vehicle_ref_coords_test coords[2] = {{0.0F, 0.0F, FLT_MAX, 0}, {0.0F, 0.0F, FLT_MAX, 0}};

static struct vehicle_ref_coords_test ref_coords0[] = {
    {34.544909F, -102.100843F, FLT_MAX, 0}, {32.345544F, -99.123124F, FLT_MAX, 0},
    {33.234235F, -100.214124F, FLT_MAX, 0}, {35.195739F, -95.348899F, FLT_MAX, 0},
    {31.895839F, -97.789573F, FLT_MAX, 0},  {32.895839F, -101.789573F, FLT_MAX, 0},
    {34.115839F, -100.225732F, FLT_MAX, 0}, {32.335839F, -99.992232F, FLT_MAX, 0},
...
static struct vehicle_ref_coords_test ref_coords1[] = {
    {34.544909F, -102.100843F, FLT_MAX, 0}, {32.345544F, -99.123124F, FLT_MAX, 0},
    {33.234235F, -100.214124F, FLT_MAX, 0}, {35.195739F, -95.348899F, FLT_MAX, 0},
    {31.895839F, -97.789573F, FLT_MAX, 0},  {32.895839F, -101.789573F, FLT_MAX, 0},
    {34.115839F, -100.225732F, FLT_MAX, 0}, {32.335839F, -99.992232F, FLT_MAX, 0},
        ...
        if (*myid == 0)
        {
            for (size_t coords_index = 0; coords_index < 10; coords_index++)
            {
                if ((distance = GPS_Distance(ref_coords[coords_index].latitute_ref,
                                             ...
                                             vehicle_records_ptr[i].longitude)) < coords[coords_index].distance)
                {
                    coords[0].distance            = distance;
                    coords[0].latitute_ref        = vehicle_records_ptr[i].latitute;
                    coords[0].longitude_ref       = vehicle_records_ptr[i].longitude;
                    coords[0].position_id_nearest = vehicle_records_ptr[i].position_id;
                }
            }
        }
        ...
        else
        {
            for (size_t coords_index = 0; coords_index < 10; coords_index++)
            {
                if ((distance = GPS_Distance(ref_coords[coords_index].latitute_ref,
                                             ...
                                             vehicle_records_ptr[i].longitude)) < coords[coords_index].distance)
                {
                    coords[1].distance            = distance;
                    coords[1].latitute_ref        = vehicle_records_ptr[i].latitute;
                    coords[1].longitude_ref       = vehicle_records_ptr[i].longitude;
                    coords[1].position_id_nearest = vehicle_records_ptr[i].position_id;
                }
            }
        }
        // ref_coords[coords_index].position_id_nearest = vehicle_records[record_index].position_id;
